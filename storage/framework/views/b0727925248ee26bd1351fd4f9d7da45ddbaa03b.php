...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="Business_name" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Business Name')); ?><em style="color:red">*fill only for company registration </em></label>

                            <div class="col-md-6">
                                <input id="Business_name" type="text" class="form-control " name="Business_name" value="<?php echo e(old('Business_name')); ?>" placeholder="only for company registration">
...
unset($__errorArgs, $__bag); ?>" name="role_id" required autocomplete="role_id" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\MyJobs\resources\views/auth/register.blade.php ENDPATH**/ ?>